 ...
 *   https://datatables.net/download/#bs4/dt-1.13.4/b-2.3.6/cr-1.6.2/fh-3.3.2/sb-1.4.2/sl-1.6.2
 *
 * Included libraries:
 *   DataTables 1.13.4, Buttons 2.3.6, ColReorder 1.6.2, FixedHeader 3.3.2, SearchBuilder 1.4.2, Select 1.6.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs4/dt-1.13.4/b-2.3.6/cr-1.6.2/fh-3.3.2/sb-1.4.2/sl-1.6.2",
